...
OptionsPageAntialiasingHelp = "Anti-aliasing makes objects seen in the game look better, by smoothing out the edges on models. Enabling this may impact the game's performance.\n\nYou can adjust the strength in your preferences file, located in the Toontown's Funny Farm installation folder."
