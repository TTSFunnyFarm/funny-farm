...
OptionsPageAntialiasingOnLabel = 'Antialiasing is on.'
OptionsPageAntialiasingOffLabel = 'Antialiasing is off.'
...
OptionsPageAntialiasingHelp = 'Antialiasing makes objects in the game look better by smoothing out jagged edges on models, but it can reduce performance.\n\n(You can adjust the intensity in your preferences file.)'
OptionsPageLODHelp = 'LOD nodes show lower quality models for characters as you move farther away from them.\n\nTurning off LODs will always use the highest quality models for characters, at a minor cost to performance.'
