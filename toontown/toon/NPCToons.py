...
NPCToonDict = {
 ...
 7009: (-1,
        ...
        0,
        NPC_REGULAR)}
# Funny Farm's NPC toon dictionary. We'll reuse most of the NPCs from places like gag shops, pet shops, 
# HQs, etc but we also need to assign them to new zones because we're in Funny Farm, not Toontown :)
FFNPCToonDict = {
 1001: (1514,
        lnames[2001],
        ('dss',
...
def generateZone2NpcDict():
    for id, npcDesc in FFNPCToonDict.items():
        zoneId = npcDesc[0]
