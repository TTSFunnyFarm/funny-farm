...
def getSuitAttack(suitName, suitLevel, attackNum = -1):
    ...
    name = attack[0]
    adict['name'] = name
    adict['id'] = list(SuitAttacks).index(name)
    adict['animName'] = SuitAttacks[name][0]
...
AUDIT = list(SuitAttacks).index('Audit')
BITE = list(SuitAttacks).index('Bite')
BOUNCE_CHECK = list(SuitAttacks).index('BounceCheck')
BRAIN_STORM = list(SuitAttacks).index('BrainStorm')
BUZZ_WORD = list(SuitAttacks).index('BuzzWord')
CALCULATE = list(SuitAttacks).index('Calculate')
CANNED = list(SuitAttacks).index('Canned')
CHOMP = list(SuitAttacks).index('Chomp')
CIGAR_SMOKE = list(SuitAttacks).index('CigarSmoke')
CLIPON_TIE = list(SuitAttacks).index('ClipOnTie')
CRUNCH = list(SuitAttacks).index('Crunch')
DEMOTION = list(SuitAttacks).index('Demotion')
DOWNSIZE = list(SuitAttacks).index('Downsize')
DOUBLE_TALK = list(SuitAttacks).index('DoubleTalk')
EVICTION_NOTICE = list(SuitAttacks).index('EvictionNotice')
EVIL_EYE = list(SuitAttacks).index('EvilEye')
FILIBUSTER = list(SuitAttacks).index('Filibuster')
FILL_WITH_LEAD = list(SuitAttacks).index('FillWithLead')
FINGER_WAG = list(SuitAttacks).index('FingerWag')
FIRED = list(SuitAttacks).index('Fired')
FIVE_O_CLOCK_SHADOW = list(SuitAttacks).index('FiveOClockShadow')
FLOOD_THE_MARKET = list(SuitAttacks).index('FloodTheMarket')
FOUNTAIN_PEN = list(SuitAttacks).index('FountainPen')
FREEZE_ASSETS = list(SuitAttacks).index('FreezeAssets')
GAVEL = list(SuitAttacks).index('Gavel')
GLOWER_POWER = list(SuitAttacks).index('GlowerPower')
GUILT_TRIP = list(SuitAttacks).index('GuiltTrip')
HALF_WINDSOR = list(SuitAttacks).index('HalfWindsor')
HANG_UP = list(SuitAttacks).index('HangUp')
HEAD_SHRINK = list(SuitAttacks).index('HeadShrink')
HOT_AIR = list(SuitAttacks).index('HotAir')
JARGON = list(SuitAttacks).index('Jargon')
LEGALESE = list(SuitAttacks).index('Legalese')
LIQUIDATE = list(SuitAttacks).index('Liquidate')
MARKET_CRASH = list(SuitAttacks).index('MarketCrash')
MUMBO_JUMBO = list(SuitAttacks).index('MumboJumbo')
PARADIGM_SHIFT = list(SuitAttacks).index('ParadigmShift')
PECKING_ORDER = list(SuitAttacks).index('PeckingOrder')
PICK_POCKET = list(SuitAttacks).index('PickPocket')
PINK_SLIP = list(SuitAttacks).index('PinkSlip')
PLAY_HARDBALL = list(SuitAttacks).index('PlayHardball')
POUND_KEY = list(SuitAttacks).index('PoundKey')
POWER_TIE = list(SuitAttacks).index('PowerTie')
POWER_TRIP = list(SuitAttacks).index('PowerTrip')
QUAKE = list(SuitAttacks).index('Quake')
RAZZLE_DAZZLE = list(SuitAttacks).index('RazzleDazzle')
RED_TAPE = list(SuitAttacks).index('RedTape')
RE_ORG = list(SuitAttacks).index('ReOrg')
RESTRAINING_ORDER = list(SuitAttacks).index('RestrainingOrder')
ROLODEX = list(SuitAttacks).index('Rolodex')
RUBBER_STAMP = list(SuitAttacks).index('RubberStamp')
RUB_OUT = list(SuitAttacks).index('RubOut')
SACKED = list(SuitAttacks).index('Sacked')
SANDTRAP = list(SuitAttacks).index('SandTrap')
SCHMOOZE = list(SuitAttacks).index('Schmooze')
SHAKE = list(SuitAttacks).index('Shake')
SHRED = list(SuitAttacks).index('Shred')
SONG_AND_DANCE = list(SuitAttacks).index('SongAndDance')
SPIN = list(SuitAttacks).index('Spin')
SYNERGY = list(SuitAttacks).index('Synergy')
TABULATE = list(SuitAttacks).index('Tabulate')
TEE_OFF = list(SuitAttacks).index('TeeOff')
THROW_BOOK = list(SuitAttacks).index('ThrowBook')
TREMOR = list(SuitAttacks).index('Tremor')
WATERCOOLER = list(SuitAttacks).index('Watercooler')
