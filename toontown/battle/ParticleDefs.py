...
def gearExplosion(self):
    ...
    p0.factory.setLifespanSpread(0)
    p0.factory.setMassBase(1)
    p0.factory.setMassSpread(0)
    p0.factory.setTerminalVelocityBase(400)
    p0.factory.setTerminalVelocitySpread(0)
    ...
    p0.renderer.setInitialXScale(0.160)
    p0.renderer.setFinalXScale(0.160)
    p0.renderer.setInitialYScale(0.160)
    ...
    p0.emitter.setAmplitude(9)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 9))
    p0.emitter.setExplicitLaunchVector(Vec3(1.0, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -2))
    # Sphere Volume parameters
    p0.emitter.setRadius(3.2282)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -79), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.01, 1)
    force0.setActive(1)
    f0.addForce(force0)
...
def smokeTest4(self):
    ...
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(2)
    p0.renderer.setFinalXScale(4)
    p0.renderer.setInitialYScale(2)
    p0.renderer.setFinalYScale(4)
    p0.renderer.setNonanimatedTheta(0)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(0)
    ...
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 6))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Disc parameters
    p0.emitter.setRadius(1)
    self.addParticles(p0)
...
def gearExplosionSmall(self):
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -79), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.0100, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def gearExplosionBig(self):
    ...
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 18))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -2))
    # Sphere Volume parameters
...
def poundkey(self):
    ...
    p0.factory.setMassBase(1)
    p0.factory.setMassSpread(0)
    p0.factory.setTerminalVelocityBase(20)
    p0.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    ...
    p0.renderer.setYScaleFlag(1)
    p0.renderer.setAnimAngleFlag(0)
    p0.renderer.setInitialXScale(0)
    p0.renderer.setFinalXScale(0.600)
    p0.renderer.setInitialYScale(0)
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 4, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.200)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0, 0, 0), 100, 0)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def shred(self):
    ...
    p0.emitter.setAmplitudeSpread(1)
    p0.emitter.setOffsetForce(Vec3(0, 3.0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -7.0, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.6000)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0, 0, 5.0), 1, 0)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearSinkForce(Point3(0, 0, -8), LinearDistanceForce.FTONEOVERRSQUARED, 14.5479, 155.9407, 1)
    force1.setActive(1)
    f0.addForce(force1)
...
def withdrawal(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 1.5, 0))
    # Disc parameters
    p0.emitter.setRadius(1.7)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0, 1, 0), 1, 0)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def buzzWord(self):
    ...
    p0.renderer.setFinalYScale(0.05)
    p0.renderer.setNonanimatedTheta(20)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(0)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(8)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 7, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -3, 0))
    # Sphere Volume parameters
...
def penSpill(self):
    ...
    p0.renderer.setFinalXScale(0)
    p0.renderer.setInitialYScale(0.05)
    p0.renderer.setFinalYScale(0)
    p0.renderer.setNonanimatedTheta(90)
    p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
    p0.renderer.setAlphaDisable(0)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(3)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -2))
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -99), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.01, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def fingerwag(self):
    ...
    p0.emitter.setAmplitude(3)
    p0.emitter.setAmplitudeSpread(2)
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Point parameters
    p0.emitter.setLocation(Point3(0, 0, 0))
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('jfo')
    # Force parameters
    force0 = LinearJitterForce(4, 0)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearSourceForce(Point3(0, 0, 0), LinearDistanceForce.FTONEOVERRSQUARED, 0.5, 1, 0)
    force1.setActive(1)
    f0.addForce(force1)
    force2 = LinearSinkForce(Point3(0, 1, 0), LinearDistanceForce.FTONEOVERRSQUARED, 1, 1, 1)
    force2.setActive(1)
    f0.addForce(force2)
    self.addForceGroup(f0)
...
def doubleTalkRight(self):
    self.reset()
    self.setPos(0, 3.000, 3.000)
    self.setHpr(-55.000, 0, 0)
    ...
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0.6000, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -8, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.0500)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(-6.000, -3.0, 0), LinearDistanceForce.FTONEOVERRSQUARED, 1, 1.5000, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def filibusterSpray(self):
    self.reset()
    self.setPos(0, 3.000, 4.000)
    self.setHpr(0, 55.000, 0)
    self.setScale(1, 1, 1)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    ...
    p0.emitter.setAmplitude(5.0)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 8, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -1, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.1)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, -9.0, -11), LinearDistanceForce.FTONEOVERRSQUARED, 1, 1.3661, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def schmoozeLowerSpray(self):
    ...
    p0.emitter.setAmplitude(5.0)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 11, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -1, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.1)
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, -23.0, 9.0), LinearDistanceForce.FTONEOVERRSQUARED, 1, 1.3661, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def brainStorm(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 5.0))
    # Disc parameters
...
def numberSpray(self):
    self.reset()
    self.setPos(0, 2.700, 3.900)
    self.setHpr(-180, 80.000, -180)
    self.setScale(1, 1, 1)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    ...
    p0.emitter.setOffsetForce(Vec3(0, 9.1000, -4))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -4, 0))
    # Sphere Volume parameters
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -3.5), LinearDistanceForce.FTONEOVERRSQUARED, 1, 2.5308, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, -10, 0), 1, 0)
    force1.setActive(1)
    f0.addForce(force1)
    self.addForceGroup(f0)
...
def downsizeSpray(self):
    self.reset()
    self.setPos(0, 2.900, 3.400)
    self.setHpr(0, 60.000, 0)
    self.setScale(1, 1, 1)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    ...
    p0.emitter.setOffsetForce(Vec3(0, 7.0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -3.0, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.0010)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -5.3000), LinearDistanceForce.FTONEOVERRSQUARED, 1, 2.5308, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, -7.0, 0), 1, 0)
    force1.setActive(1)
    f0.addForce(force1)
...
def fillWithLeadSpray(self):
    ...
    p0.emitter.setAmplitude(5.0)
    p0.emitter.setAmplitudeSpread(1)
    p0.emitter.setOffsetForce(Vec3(0, 5.0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -7.0, 0))
    # Sphere Volume parameters
...
def demotionSpray(self):
    ...
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 6.0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -4, 0))
    # Sphere Volume parameters
...
def powertrip2(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 1.1, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -4, 0))
    # Sphere Volume parameters
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(-10, 0, 0), LinearDistanceForce.FTONEOVERRSQUARED, 1, 2.5308, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, 0, 0), 1, 0)
    force1.setActive(1)
    f0.addForce(force1)
...
def rollodexVortex(self):
    ...
    p0.factory.setMassBase(1)
    p0.factory.setMassSpread(0)
    p0.factory.setTerminalVelocityBase(40)
    p0.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHANONE)
    ...
    # Force parameters
    force0 = LinearSourceForce(Point3(0, 0, 0), LinearDistanceForce.FTONEOVERRSQUARED, 1, 1, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearSinkForce(Point3(0, 0, 0), LinearDistanceForce.FTONEOVERRSQUARED, 5.0, 6.0, 0)
    force1.setActive(0)
    f0.addForce(force1)
    force2 = LinearCylinderVortexForce(1, 1, 15.0, 1, 0)
    force2.setActive(1)
    f0.addForce(force2)
    force3 = LinearSourceForce(Point3(0.5, 0, 1), LinearDistanceForce.FTONEOVERRCUBED, 4, 4, 1)
    force3.setActive(1)
    f0.addForce(force3)
    self.addForceGroup(f0)
...
def pixieExplode(self):
    ...
    p0.renderer.setDeathRadius(0)
    p0.renderer.setLifeScale(SparkleParticleRenderer.SPNOSCALE)
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETEXPLICIT)
    p0.emitter.setAmplitude(1)
    p0.emitter.setAmplitudeSpread(0.0100)
    p0.emitter.setOffsetForce(Vec3(-0.1, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1.5000, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -4, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.1)
    self.addParticles(p0)
...
def soundBreak(self):
    ...
    p0.factory.setInitialAngleSpread(180)
    p0.factory.enableAngularVelocity(1)
    p0.factory.setAngularVelocity(0)
    p0.factory.setAngularVelocitySpread(0)
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAINOUT)
    p0.renderer.setUserAlpha(1.00)
    # Sprite parameters
...
def waterfall(self):
    self.reset()
    self.setPos(0, 5.000, 2.300)
    self.setHpr(0, -45.000, 0)
    self.setScale(4.000, 4.000, 4.000)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -30), LinearDistanceForce.FTONEOVERRSQUARED, 3.0400, 1.5000, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def firedFlame(self):
    ...
    p0.emitter.setAmplitude(1)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 4.800))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -30))
    # Sphere Volume parameters
...
def spinSpray(self):
    self.reset()
    self.setPos(0, 6.500, 3.200)
    self.setHpr(50.000, -0.000, -90)
    self.setScale(1, 1, 1)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -3.0), LinearDistanceForce.FTONEOVERRSQUARED, 1, 2.5308, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, 0, 0), 1, 0)
    force1.setActive(1)
...
def confetti(self):
    ...
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearSinkForce(Point3(0, 0, -0.8), LinearDistanceForce.FTONEOVERRSQUARED, 0.5, 1, 1)
...
def synergyWaterfall(self):
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -15.0), LinearDistanceForce.FTONEOVERRSQUARED, 3.0400, 1.5000, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def calculate(self):
    ...
    p0.factory.setTerminalVelocityBase(8)
    p0.factory.setTerminalVelocitySpread(4)
    # Point factory parameters
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAOUT)
    p0.renderer.setUserAlpha(1.00)
    ...
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(11)
    p0.emitter.setAmplitudeSpread(2.0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -2.0, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.5)
    self.addParticles(p0)
...
def spriteFiredFlecks(self):
    ...
    p0.emitter.setAmplitude(1)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 4))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -4))
    # Sphere Volume parameters
...
def smile(self):
    self.reset()
    self.setPos(0.0, 0.0, 2)
    self.setHpr(85.000, 0, 90)
    #self.setScale(1, 1, 1)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    ...
    p0.factory.setMassBase(1)
    p0.factory.setMassSpread(0)
    p0.factory.setTerminalVelocityBase(200)
    p0.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAOUT)
...
def trickleLiquidate(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 6.0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.4500)
    self.addParticles(p0)
...
def mumboJumboSpray(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -9.0, 0))
    # Sphere Volume parameters
...
def gearExplosionWide(self):
    ...
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 10))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -0.5))
    # Sphere Volume parameters
    p0.emitter.setRadius(1.7500)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -79.0), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.0, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def pixieSpray(self):
    self.reset()
    self.setPos(2.00, 0, 4.00)
    self.setHpr(-90, 45.000, 0)
    self.setScale(4.000, 4.000, 4.000)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
...
def synergy(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(-4, 0, 0))
    # Ring parameters
...
def soundWave(self):
    ...
    p0.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p0.factory.setLifespanBase(4)
    p0.factory.setLifespanSpread(0)
    p0.factory.setMassBase(0.0010)
    p0.factory.setMassSpread(0)
    p0.factory.setTerminalVelocityBase(0)
    p0.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAOUT)
...
def tnt(self):
    self.reset()
    self.setPos(0, 0, -0.600)
    self.setHpr(0, 10.000, 0)
    self.setScale(1, 1, 1)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -2.0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.2282)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -19.0), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.0100, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def pixieWall(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(0, 0, 1))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -1))
    # Disc parameters
    p0.emitter.setRadius(0.5)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
...
def firedBaseFlame(self):
    ...
    p0.emitter.setAmplitude(1)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 2.200))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -30))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.4)
...
def headShrinkSpray(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 5.1000, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -4, 0))
    # Sphere Volume parameters
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -4), LinearDistanceForce.FTONEOVERRSQUARED, 1, 2.5308, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, -7.0, 0), 1, 0)
    force1.setActive(1)
...
def jargonSpray(self):
    ...
    p0.emitter.setAmplitude(5.0)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 4, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -9.0, 0))
    # Line parameters
    p0.emitter.setEndpoint1(Point3(0, 0, 0))
    p0.emitter.setEndpoint2(Point3(0, 0, 0))
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
...
def legaleseSpray(self):
    ...
    p0.emitter.setAmplitude(8)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 7.0, -1))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -3.0, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.0010)
...
def spinEffect(self):
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 1.2, 0), LinearDistanceForce.FTONEOVERRSQUARED,1, 20, 1)
    force0.setActive(1)
    f0.addForce(force0)
...
def restrainingOrderCloud(self):
    ...
    p0.emitter.setOffsetForce(Vec3(0, 6.0, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, -18, 0))
    # Sphere Volume parameters
    p0.emitter.setRadius(0.8900)
    self.addParticles(p0)
...
def numberSpill(self):
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -33.0), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.0100, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def rollodexWaterfall(self):
    ...
    force0.setActive(0)
    f0.addForce(force0)
    force1 = LinearSinkForce(Point3(0, 0, 10), LinearDistanceForce.FTONEOVERRCUBED, 2.9550, 50, 1)
    force1.setActive(1)
    f0.addForce(force1)
    self.addForceGroup(f0)
...
def shiftSpray(self):
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, 96.0), LinearDistanceForce.FTONEOVERRSQUARED, 3.0400, 1.5000, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def hotAirSpray(self):
    self.reset()
    self.setPos(0, 2.500, 3.200) # originally (0,4,4)
    self.setHpr(-180, 80.000, -180)
    self.setScale(1, 1, 1)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
...
def resistanceEffectSparkle(self):
    ...
    # Emitter parameters
    p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
    p0.emitter.setAmplitude(20)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 20))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Sphere Volume parameters
...
def tt_p_efx_rocketLaunchFire(self):
    ...
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Line parameters
    p0.emitter.setEndpoint1(Point3(1, 0, 0))
    p0.emitter.setEndpoint2(Point3(0, 0, 0))
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('Gravity')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0, 0, 2.5), 1, 0)
    force0.setVectorMasks(1, 1, 1)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, 0, -3.0), 5.0, 0)
    force1.setVectorMasks(1, 1, 1)
    force1.setActive(1)
    f0.addForce(force1)
    self.addForceGroup(f0)
...
def resistanceEffectSprite(self):
    ...
    p1.factory.setLifespanSpread(0)
    p1.factory.setMassBase(1)
    p1.factory.setMassSpread(0)
    p1.factory.setTerminalVelocityBase(400)
    p1.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    ...
    p1.renderer.setNonanimatedTheta(0)
    ...
    p1.emitter.setAmplitude(20)
    p1.emitter.setAmplitudeSpread(0)
    p1.emitter.setOffsetForce(Vec3(0, 0, 20))
    p1.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p1.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Sphere Volume parameters
    ...
    p2.setSystemLifespan(0)
    p2.setLocalVelocityFlag(1)
    p2.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p2.factory.setLifespanBase(3.0)
    p2.factory.setLifespanSpread(0)
    p2.factory.setMassBase(1)
    p2.factory.setMassSpread(0)
    p2.factory.setTerminalVelocityBase(400)
    p2.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    ...
    p2.renderer.setNonanimatedTheta(0)
    ...
    p2.emitter.setAmplitude(20)
    p2.emitter.setAmplitudeSpread(0)
    p2.emitter.setOffsetForce(Vec3(0, 0, 20))
    p2.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p2.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Sphere Volume parameters
    ...
    p3.setSystemLifespan(0)
    p3.setLocalVelocityFlag(1)
    p3.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p3.factory.setLifespanBase(3.0)
    p3.factory.setLifespanSpread(0)
    p3.factory.setMassBase(1)
    p3.factory.setMassSpread(0)
    p3.factory.setTerminalVelocityBase(400)
    p3.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    ...
    p3.renderer.setNonanimatedTheta(0)
    ...
    p3.emitter.setAmplitude(20)
    p3.emitter.setAmplitudeSpread(0)
    p3.emitter.setOffsetForce(Vec3(0, 0, 20))
    p3.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p3.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Sphere Volume parameters
    ...
    p4.setSystemLifespan(0)
    p4.setLocalVelocityFlag(1)
    p4.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p4.factory.setLifespanBase(3.0)
    p4.factory.setLifespanSpread(0)
    p4.factory.setMassBase(1)
    p4.factory.setMassSpread(0)
    p4.factory.setTerminalVelocityBase(400)
    p4.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    ...
    p4.renderer.setNonanimatedTheta(0)
    ...
    p4.emitter.setAmplitude(20)
    p4.emitter.setAmplitudeSpread(0)
    p4.emitter.setOffsetForce(Vec3(0, 0, 20))
    p4.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p4.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Sphere Volume parameters
    ...
    p5.setSystemLifespan(0)
    p5.setLocalVelocityFlag(1)
    p5.setSystemGrowsOlderFlag(0)
    # Factory parameters
    p5.factory.setLifespanBase(3.0)
    p5.factory.setLifespanSpread(0)
    p5.factory.setMassBase(1)
    p5.factory.setMassSpread(0)
    p5.factory.setTerminalVelocityBase(400)
    p5.factory.setTerminalVelocitySpread(0)
    # Point factory parameters
    # Renderer parameters
    ...
    p5.renderer.setNonanimatedTheta(0)
    ...
    p5.emitter.setAmplitude(20)
    p5.emitter.setAmplitudeSpread(0)
    p5.emitter.setOffsetForce(Vec3(0, 0, 20))
    p5.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p5.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Sphere Volume parameters
...
def splashlines(self):
    ...
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, 0, 9.0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, -2.0))
    # Sphere Volume parameters
    p0.emitter.setRadius(3.2282)
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -79.0), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 95.0100, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
...
def tt_p_efx_rocketLaunchSmoke(self):
    self.reset()
    self.setPos(0, 0, 16.000)
    self.setHpr(0, 0, 0)
    self.setScale(2, 2, 3.000)
    p0 = Particles.Particles('particles-1')
    # Particles parameters
    p0.setFactory("PointParticleFactory")
    p0.setRenderer("SpriteParticleRenderer")
    ...
    p0.emitter.setAmplitude(0.4)
    p0.emitter.setAmplitudeSpread(2.0)
    p0.emitter.setOffsetForce(Vec3(0, 0, -5.0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Disc parameters
    p0.emitter.setRadius(1)
...
def sparks(self):
    ...
    p0.emitter.setAmplitudeSpread(10)
    p0.emitter.setOffsetForce(Vec3(0, 1, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(0, 0, 1))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Line parameters
    p0.emitter.setEndpoint1(Point3(0.5, 5.0, -0.5))
    p0.emitter.setEndpoint2(Point3(0.75000, -5.0, 2.5))
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('sparkforces')
    # Force parameters
    force0 = LinearVectorForce(Vec3(1, 0, 0), -50, 0)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, -1, 0), 100, 0)
    force1.setActive(1)
    f0.addForce(force1)
    force2 = LinearVectorForce(Vec3(0, 0, -1), 20, 0)
    force2.setActive(1)
    f0.addForce(force2)
    force3 = LinearJitterForce(50, 0)
    force3.setActive(1)
    f0.addForce(force3)
    self.addForceGroup(f0)
...
def drift(self):
    ...
    p0.factory.setFinalAngle(0)
    p0.factory.setFinalAngleSpread(0)
    p0.factory.setAngularVelocity(0)
    p0.factory.setAngularVelocitySpread(90)
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAOUT)
    ...
    # Force parameters
    force0 = LinearVectorForce(Vec3(1, 0, 0), 0, 0)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearVectorForce(Vec3(0, -1, 0), 100, 0)
    force1.setActive(1)
    f0.addForce(force1)
    force2 = LinearVectorForce(Vec3(0, 0, 1), 50, 0)
    force2.setActive(1)
    f0.addForce(force2)
    force4 = LinearJitterForce(100, 0)
    force4.setActive(1)
    f0.addForce(force4)
    self.addForceGroup(f0)
...
def snowdisk(self):
    ...
    # Z Spin factory parameters
    p0.factory.setInitialAngle(0)
    p0.factory.setInitialAngleSpread(10)
    p0.factory.enableAngularVelocity(1)
    p0.factory.setAngularVelocity(0)
    p0.factory.setAngularVelocitySpread(500)
    # Renderer parameters
    p0.renderer.setAlphaMode(BaseParticleRenderer.PRALPHAIN)
    p0.renderer.setUserAlpha(1.00)
    # Sprite parameters
    ...
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Disc parameters
    p0.emitter.setRadius(50)
    self.addParticles(p0)
    f0 = ForceGroup.ForceGroup('gravity')
    # Force parameters
    force0 = LinearVectorForce(Vec3(0, 0, -1), 1.5000, 0)
    force0.setActive(1)
    f0.addForce(force0)
    force1 = LinearJitterForce(10, 0)
    force1.setActive(1)
    f0.addForce(force1)
    self.addForceGroup(f0)
...
def bossCogFrontAttack(self):
    ...
    p0.emitter.setAmplitude(5.0)
    p0.emitter.setAmplitudeSpread(0)
    p0.emitter.setOffsetForce(Vec3(0, -10, 0))
    p0.emitter.setExplicitLaunchVector(Vec3(1, 0, 0))
    p0.emitter.setRadiateOrigin(Point3(0, 0, 0))
    # Sphere Surface parameters
    p0.emitter.setRadius(1)
    ...
    f0 = ForceGroup.ForceGroup('forces')
    # Force parameters
    force0 = LinearSinkForce(Point3(0, 0, -79.0), LinearDistanceForce.FTONEOVERRSQUARED, 15.9701, 50, 1)
    force0.setActive(1)
    f0.addForce(force0)
    self.addForceGroup(f0)
