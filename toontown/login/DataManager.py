...
class DataManager:
    ...
    def createLocalAvatar(self, data):
        ...
        base.localAvatar.setQuestHistory(list(data.setQuestHistory))
        ...
        base.localAvatar.setHoodsVisited(list(data.setHoodsVisited))
        base.localAvatar.setTeleportAccess(list(data.setTeleportAccess))
        ...
        base.localAvatar.setDamage(list(data.setDamage))
        base.localAvatar.setDefense(list(data.setDefense))
        base.localAvatar.setAccuracy(list(data.setAccuracy))
