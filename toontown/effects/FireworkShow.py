...
fireworkShowTypes = [ToontownGlobals.JULY4_FIREWORKS,
 ToontownGlobals.CHRISTMAS_FIREWORKS,
...
class FireworkShow(NodePath):
    ...
    showData = {ToontownGlobals.JULY4_FIREWORKS: [[FireworkType.GlowFlare,
                                       ...
                                       [FireworkType.Mickey,
                                        ...
                                        2.0,
                                        10.0]],
ToontownGlobals.CHRISTMAS_FIREWORKS: [[FireworkType.GlowFlare,
                                    Vec3(-90, 0, 80),
                                    Vec3(120, 0, 0),
                                    rS(),
                                    Vec4(1, 1, 1, 1),
    ...
    sectionData = {ToontownGlobals.JULY4_FIREWORKS: [(0, 24), (24, len(showData[ToontownGlobals.JULY4_FIREWORKS]))],
     ToontownGlobals.CHRISTMAS_FIREWORKS: [(0, 24), (24, len(showData[ToontownGlobals.CHRISTMAS_FIREWORKS]))],
