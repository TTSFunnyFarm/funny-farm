...
AIPleaseWait = 'Starting AI services, please wait...'
...
FriendSecretIntro = "If you are playing Toontown's Funny Farm with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the Toontown\'s Funny Farm network'
