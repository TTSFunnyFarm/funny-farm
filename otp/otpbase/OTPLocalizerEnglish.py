...
SuitFaceoffTaunts = {'b': ['Would you like to make a donation?',
       ...
       "Things might blur a little.",
       "Good timing, I'm a pint low.",
       "Ah. You're just my type."],
 ...
 'ms': ['Get ready for a shake down.',
        ...
        "Things are gonna get shaky.",
        "I hope you find this next part moving."],
 'hh': ["I'm way ahead of you.",
        ...
        'You are going to have such a headache after this.',
 ...
 'cr': ["You don't fit in my corporation.",
        ...
        'I believe company policy calls for more formal attire.',
        ...
        "We seem to have some opposing methods."],
 'mh': ['Are you ready for my take?',
        'Lights, camera, action!',
        "Let's get this show rolling.",
        "There you are! For this scene, look sad for me.",
 ...
 'nc': ['Looks like your number is up.',
        ...
        'I could do with a nice crunch right about now.'],
 'ls': ["I'm here to collect what's rightfully mine.",
        ...
        "Your debt will be absolutely crushing."],
 ...
 'rb': ["You've been robbed.",
        ...
        "I'll pull the victory from under your feet.",
        "I'm a royal pain!",
        ...
        "Too bad this isn't a highway.",
        "It's only my way, the high way.",
        "You're putting up a noble effort."],
 'bs': ['Never turn your back on me.',
        ...
        "I'm not sure if I have your back on this one.",
        "You're going to have a stabbing headache soon.",
        "You're going to see a sharp decline.",
        "You'll find I have pinpoint accuracy.",
 ...
 'bw': ["Don't brush me aside.",
        ...
        "I think I found the right place to cut off.",
        "Don't worry Toon, your loss will be plenty real.",
 ...
 'le': ["Careful, my legal isn't very tender.",
        'I soar, then I score.',
        "This damage will be done from top to bottom.",
        "I'm bringing down the law on you.",
        'You should know, I have some killer instincts.',
        "I'm going to give you a legal nightmare.",
        ...
        "This arrest might cause a bit of duress."],
 'sd': ["You'll never know when I'll stop.",
        ...
        "It's my turn.",
        'I have my own spin on this.'],
 'f': ["I'm gonna tell the boss about you!",
       "I'm going to need to use you as my stepping stool.",
       ...
       "Let's see how you rate my performance.",
