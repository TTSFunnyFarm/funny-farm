...
class CMenu(DirectFrame):
    def __init__(self, container, battle):
        ...
        self.attackButton = DirectButton(parent=self, relief=None, image=buttonImage, image_scale=buttonScale, text="Attack", pos=(-0.26, 0, 0.12), text_scale=0.08, text_pos=(0, -0.02), command=self.container.showNode, extraArgs=[GAG_WHEEL])
